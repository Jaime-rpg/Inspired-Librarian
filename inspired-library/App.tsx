...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative bg-slate-50 z-0 font-nunito">
          ...
          {bookChunks.map((chunk, chunkIdx) => (
            <React.Fragment key={`pdf-pg-frag-${chunkIdx}`}>
              <div className="pdf-page-wrapper">
                {/* Header: Symmetrical content shifted slightly by the wrapper's left padding */}
                ...
                {/* Card Row: Centered within the wrapper's content area */}
              ...
              {/* Force clean break only between real pages */}
      ...
      <main className="flex-grow p-6 max-w-7xl mx-auto w-full no-print">
        {error && (
